...
<div>
List of demo pages:
<div><a href="/hooks">hooks demo</a></div>
<div><a href="/media">media demo</a></div>
</div>
</body></html>
`, {status: 200})
...
router.get("/hooks", function(_request: Request, _context: Context) {
    const response = new Response(componentPage("hooks-demo"), {status: 200})
    response.headers.set("content-type", "text/html; charset=utf-8")
    return response
})
router.get("/media", function(_request: Request, _context: Context) {
    const response = new Response(componentPage("media-demo"), {status: 200})
    response.headers.set("content-type", "text/html; charset=utf-8")
    return response
})
